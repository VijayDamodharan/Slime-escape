...
namespace Practice_game_2
{
    class Tile : PictureBox
    {
        ...
        Image middleBlock = new Bitmap(@"C:\Vijay Stuff\Coding stuff\Visual studio projects\csharp projects\Practice game 2\Middle Block 2.png");
        Image smallTopBlock = new Bitmap(@"C:\Vijay Stuff\Coding stuff\Visual studio projects\csharp projects\Practice game 2\Small top block 2.png");
        Image floatingBlock = new Bitmap(@"C:\Vijay Stuff\Coding stuff\Visual studio projects\csharp projects\Practice game 2\Floating block 2.png");
        ...
        static void SetValues(Form1 form)
        {
            tileWidth = form.Width / form.visibleTilesX;
        }
