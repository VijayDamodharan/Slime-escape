...
namespace Practice_game_2
{
    ...
    {
        Image imgRight = new Bitmap(@"C:\Vijay Stuff\Coding stuff\Visual studio projects\csharp projects\Practice game 2\Slime right.png", false);
        Image imgRightHit = new Bitmap(@"C:\Vijay Stuff\Coding stuff\Visual studio projects\csharp projects\Practice game 2\Slime right hit.png", false);
        Image imgLeft = new Bitmap(@"C:\Vijay Stuff\Coding stuff\Visual studio projects\csharp projects\Practice game 2\Slime left.png", false);
        Image imgLeftHit = new Bitmap(@"C:\Vijay Stuff\Coding stuff\Visual studio projects\csharp projects\Practice game 2\Slime left hit.png", false);

        SoundPlayer backgroundMusic = new SoundPlayer(@"C:\Vijay Stuff\Coding stuff\Visual studio projects\csharp projects\Practice game 2\bg music.wav");
        ...
        public Form1()
        {
            Directory.SetCurrentDirectory(@"C:\Vijay Stuff\Coding stuff\Visual studio projects\csharp projects\Practice game 2");
            InitializeComponent();
